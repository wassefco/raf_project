...
(function (global) {
  ...
  function injectCSS(){
    ...
    '.rtb-logo{flex-shrink:0;display:inline-flex;align-items:center;}.rtb-logo img{height:54px;width:auto;display:block;}'+
  ...
  function build(){
    ...
    nav.innerHTML =
      '<div class="rtb-inner">'+
        '<a href="raf_homepage.html" class="rtb-logo"><img src="raf_logo_web.png" alt="RAF Marketplace"></a>'+
