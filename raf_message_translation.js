/* ============================================================================
 * RAF Marketplace — MESSAGE TRANSLATION AUTHORITY  (shared, headless) — Phase H
 * ----------------------------------------------------------------------------
 ...
 *      boundary as viewing the conversation (customer owner; current owner
 *      driver while undelivered; management via drivers.suspend; support only
 *      with a complaint). A refused caller gets the conversation's own refusal
