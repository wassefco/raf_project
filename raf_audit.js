...
(function (global) {
  ...
  var A = {
    ...
    'inventory.combination.adjusted':       { tl:false, ar:'تم تعديل مخزون خيار محدد',   en:'Combination stock adjusted' },
    'inventory.combination.reserved':       { tl:false, ar:'تم حجز خيارات محددة',        en:'Combinations reserved' },
    'inventory.combination.released':       { tl:false, ar:'تم تحرير خيارات محددة',      en:'Combinations released' },
    'inventory.combination.sale_committed': { tl:false, ar:'تم بيع خيارات محددة',        en:'Combination sale committed' },
    ...
    'product.created':      { tl:false, ar:'تمت إضافة منتج',              en:'Product created' },
    ...
    /* marketing — only the actions the Marketing Center actually performs */
    'promotion.created':    { tl:false, ar:'تمت إضافة عرض',               en:'Promotion created' },
    'promotion.updated':    { tl:false, ar:'تم تعديل عرض',                en:'Promotion updated' },
    'promotion.enabled':    { tl:false, ar:'تم تفعيل عرض',                en:'Promotion enabled' },
    'promotion.disabled':   { tl:false, ar:'تم إيقاف عرض',                en:'Promotion disabled' },
    'coupon.created':       { tl:false, ar:'تمت إضافة كوبون',             en:'Coupon created' },
    'coupon.updated':       { tl:false, ar:'تم تعديل كوبون',              en:'Coupon updated' },
    'coupon.enabled':       { tl:false, ar:'تم تفعيل كوبون',              en:'Coupon enabled' },
    'coupon.disabled':      { tl:false, ar:'تم إيقاف كوبون',              en:'Coupon disabled' },
    'advertisement.created':{ tl:false, ar:'تمت إضافة إعلان',             en:'Advertisement created' },
